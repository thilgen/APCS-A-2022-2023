...
public class Maze {
  ...
  public void loadMaze(String path) throws IOException {
    ...
    highlighted = new boolean[newWidth][newHeight];
    width = newWidth;
    height = newHeight;
  }
  ...
  public boolean isHighlighted(int x, int y) {
    return isValidLocation(x, y) && highlighted[x][y];
  }
  ...
  public void illuminate(int x, int y) {
    ...
    // [ggrossman 04/02/23] Disabled for Unit 10 Project; everything will be lit.
